package abhishekint.com.mapprrgithub.util;
...
public class RoundedImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable == null) {
            ...
            paint.setColor(ContextCompat.getColor(getContext(), R.color.reycler_back));
    ...
    public Bitmap getCroppedBitmap(Bitmap bmp, int radius) {
        ...
        @ColorInt int color = getContext().getResources().getColor(R.color.reycler_back);
